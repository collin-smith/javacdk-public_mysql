...
public class JavacdkPublicMysqlStack extends Stack {
    public JavacdkPublicMysqlStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public JavacdkPublicMysqlStack(final Construct scope, final String id, final StackProps props) {
        ...
        .description("")
         .value("Secrets Manager VPC Endpoint Id:"+ smVpcEndpoint.getVpcEndpointId())
         .build();
